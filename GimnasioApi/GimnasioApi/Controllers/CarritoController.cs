...
namespace GimnasioApi.Controllers
{
    ...
    public class CarritoController : ControllerBase
    {
        ...
        public IActionResult RemoverProductoCarrito(Carrito model)
        {
            ...
            {
                var respuesta = new Respuesta();
                var result = context.Execute("RemoverProductoCarrito", new { model.IdUsuario, model.ConsecutivoProducto });
        ...
        public IActionResult PagarCarrito(Carrito model)
        {
            ...
            {
                var respuesta = new Respuesta();
                var result = context.Execute("PagarCarrito", new { model.IdUsuario });
